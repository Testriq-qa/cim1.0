...
const Services = () => {
  const services = [
    {
      ...
      positioning: "Build fast, secure and conversion focused digital experiences.",
      description: "We design and develop responsive websites and web apps that load fast, rank well, and turn visitors into leads and customers. From landing pages to full web apps, our work is performance-first and built to scale.",
      services: [
    ...
    },
    {
      ...
      description: "We craft cohesive brand systems and product interfaces that build trust, improve usability and drive action from logos to full UI systems and high-impact video.",
      services: [
    ...
    },
    {
      ...
      description: "From technical fixes to content strategy and authority building, we help your site rank for keywords that convert delivering traffic that compounds over time.",
      services: [
    ...
    },
    {
      ...
      description: "We create content that resonates, manage publishing, and build communities that convert. From organic storytelling to creator collaborations, we make brands worth following.",
      services: [
    ...
    },
    {
      ...
      description: "ROI-first campaign planning, creative testing, and precise targeting across platforms — we scale what works and cut what doesn't to maximize ROI.",
      services: [
    ...
    },
    {
      ...
      description: "Automate repetitive tasks, speed up lead response, and create predictable funnels — from first touch to closed deal - using CRM, WhatsApp, scripts and ad-level automations.",
      services: [
    ...
    },
    {
      ...
      positioning: "Instant responses, qualified leads, and higher conversions - 24/7.",
      description: "Deploy intelligent chat assistants that can sell, qualify, collect feedback and enrich lead data across web and messaging channels in multiple languages.",
      services: [
    ...
    },
    {
      ...
      positioning: "Smart operational support that frees your team to sell and scale.",
      description: "We handle the repetitive, data-heavy and research work so your core team can focus on strategy and growth. From clean lead data to market insights and day-to-day admin.",
      services: [
  ...
  return (
    <section id="services" className="py-20 bg-gradient-to-br from-neutral-50 to-gray-100">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-neutral-600 max-w-4xl mx-auto leading-relaxed">
            From strategy to execution, we provide end-to-end digital services powered by cutting-edge technology and creative excellence.
          </p>
        </motion.div>
          ...
          {services.map((service, index) => (
            ...
            >
              ...
              <div className="flex items-start mb-6 relative z-10">
                <div className={`p-4 rounded-2xl ${service.iconBg} text-white mr-4 group-hover:scale-110 transition-transform duration-300 brand-shadow`}>
              ...
              <div className="space-y-3 relative z-10">
                <h4 className="font-semibold text-neutral-900 mb-4">Key Services:</h4>
        ...
        <motion.div
          ...
          transition={{ duration: 0.8 }}
          viewport={{ once: true }}
          className="text-center bg-gradient-to-r from-white to-gray-50 p-10 rounded-3xl brand-shadow-lg border border-white/50"
        >
          <p className="text-lg text-neutral-700 mb-4">
            Looking for <span className="font-bold gradient-text-secondary">Software Testing</span> services as well?
          </p>
