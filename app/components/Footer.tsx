        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          >
            ...
            <p className="text-gray-300 mb-6 leading-relaxed">
              Complete digital transformation agency helping businesses grow through strategic web development, marketing, and AI-powered solutions.
            </p>
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h4 className="text-lg font-semibold mb-6 gradient-text-primary">Quick Links</h4>
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h4 className="text-lg font-semibold mb-6 gradient-text-secondary">Our Services</h4>
            <ul className="space-y-3">
          ...
          >
            <h4 className="text-lg font-semibold mb-6">
              <span className="bg-gradient-to-r from-brand-cyan to-brand-teal bg-clip-text text-transparent">Contact Info</span>
            </h4>
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="text-gray-300">Mon-Fri: 9AM-7PM IST</p>
              </div>
            </div>
          </motion.div>
        </div>
        ...
        >
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex items-center space-x-6 text-sm text-gray-400">
              ...
              <a href="#" className="hover:text-brand-purple transition-colors duration-300">
                Terms of Service
              </a>
