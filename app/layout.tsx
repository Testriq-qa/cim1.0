...
export const metadata: Metadata = {
  ...
  description:
    "Transform your business with Cinute InfoMedia comprehensive digital services: conversion-driven websites, brand identity, SEO, social media marketing, performance ads, AI chatbots & automation workflows. Expert digital agency delivering measurable ROI.",
  keywords: [
  ...
  openGraph: {
    ...
    description:
      "Leading digital agency offering web development, SEO, social media marketing, performance ads, AI automation & brand identity services. Transform your business with measurable results.",
    images: [
      {
        url: "/og-image.jpg",
        width: 1200,
  ...
  twitter: {
    ...
    description:
      "Transform your business with our comprehensive digital services & AI-powered solutions. Expert team delivering measurable ROI.",
    images: {
      url: "/og-image.jpg",
              ...
              "@graph": [
                {
                  ...
                  description:
                    "Leading digital marketing agency providing comprehensive web development, SEO, social media marketing, performance advertising, and AI automation services",
                  url: "https://cinute-infomedia.com",
                  logo: {
                    "@type": "ImageObject",
                  ...
                  potentialAction: [
                    {
                      ...
                      target: {
                        "@type": "EntryPoint",
                        urlTemplate:
                          "https://cinute-infomedia.com/search?q={search_term_string}",
                      },
                    ...
                    itemListElement: [
                      ...
                      },
                      {
                        ...
                        itemOffered: {
                          ...
                          description:
                            "Comprehensive social media strategy and management",
                        },
                      },
                      {
                        "@type": "Offer",
                        itemOffered: {
                          ...
                          description:
                            "Data-driven advertising campaigns for maximum ROI",
                        },
                      },
                      {
                        "@type": "Offer",
                        itemOffered: {
                          ...
                          description:
                            "Complete brand identity and visual design services",
                        },
                      },
                      {
                        "@type": "Offer",
                        itemOffered: {
                          ...
                          name: "AI Automation",
                          description:
                            "AI-powered chatbots and marketing automation solutions",
                        },
                      },
                    ],
                  },
